...
|------|-------|------|--------|--------|
| 0001 | Stop publishing the corporate identity in this repo's commit metadata | develop | ready |  |
| 0002 | Sweep tracked files for machine-specific paths, current state, and real project names | develop | ready |  |
| 0003 | Guard CONVENTIONS_CORE.md against drift from the files it restates | design | ready |  |
