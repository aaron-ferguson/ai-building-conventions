# Backlog — AI Building Conventions
...
|------|-------|------|--------|--------|
| 0003 | Guard CONVENTIONS_CORE.md against drift from the files it restates | verify | ready |  |
| 0004 | Enforce the mechanically checkable rules with hooks instead of prose | verify | ready |  |
...
| 0009 | Align the accessibility target with the spec version it links | verify | ready |  |
